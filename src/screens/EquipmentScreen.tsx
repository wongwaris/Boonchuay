...
const EQUIPMENT: EqItem[] = [
  ...
  { id: 'pull_bar', label: 'Pull-up Bar', icon: <Ic name="human-handsup" /> },
  { id: 'cables', label: 'Cables', icon: <Ic name="cable-data" /> },
  ...
  { id: 'smith_machine', label: 'Smith Machine', icon: <Ic name="human-male-board" /> },
  { id: 'leg_press', label: 'Leg Press Machine', icon: <Ic name="seat-leg-room-normal" /> },
  { id: 'lat_pulldown', label: 'Lat Pulldown', icon: <Ic name="human-handsdown" /> },
  ...
  { id: 'calf_raise', label: 'Calf Raise Machine', icon: <Ic name="foot-print" /> },
  { id: 'battle_ropes', label: 'Battle Ropes', icon: <Ic name="wave" /> },
  { id: 'jump_rope', label: 'Jump Rope', icon: <Ic name="jump-rope" /> },
  { id: 'medicine_ball', label: 'Medicine Ball', icon: <Ic name="basketball" /> },
  { id: 'foam_roller', label: 'Foam Roller', icon: <Ic name="cylinder" /> },
  { id: 'yoga_mat', label: 'Yoga Mat', icon: <Ic name="yoga" /> },
  { id: 'trx', label: 'TRX / Suspension', icon: <Ic name="human-handsup" /> },
];
